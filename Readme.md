...
- **Administración de Sectores**: Organización territorial de clientes y planes específicos por zona en la región de Valparaíso. 
...
- **Interfaz Gráfica**: Aplicación desktop con visualización de datos mediante gráficos y tablas
...
4. **Ejecutar**: Hacer clic derecho en el proyecto → "Run"
...
4. **Abre la interfaz gráfica** principal
...
**➕ Agregar Cliente:**
- Haga clic en la pestaña "Gestión de Clientes" ubicada en la esquina superior izquierda
- Haga clic en la pestaña "Agregar Cliente"
- Complete los campos: Nombre, RUT, Domicilio, Sector y Plan
...
- Modifique información en el panel de detalles
...
**📋 Panel de Sectores:**
- Vista organizada en cuadrícula con botones para cada sector
...
- Haga clic en cualquier sector para ver información detallada

**📝 Detalles del Sector:**
- Pestaña cliente con una lista completa de clientes del sector
- También se pueden editar los clientes desde esta pestaña 
- Estadísticas de ocupación y ofertas activas

#### 🎯 3. Sistema de Captación

- El sistema identifica sectores con menos de X clientes usando un umbral configurable (por defecto 5 clientes). En la pestaña "Gestión de Sectores" puede establecer un umbral personalizado y aplicar descuentos automáticos. Los sectores críticos se destacan visualmente con indicadores de color 
...
│   ├── SectorNoEncontradoException.java
│   └── SuscripcionInvalidaException.java
...
- **Sector**: Agrupa clientes por zona geográfica con planes específicos
- **PlanSector**: Define planes de televisión con precios y ofertas por sector
- **Suscripcion**: Gestiona el estado de suscripción de un cliente, incluyendo información de pagos

#### ⚙️ Servicios de Negocio
- **ClienteService**: Gestión integral de clientes incluyendo validaciones
- **SectorService**: Administración de sectores y análisis de ocupación
- **PlanService**: Manejo de planes, precios y ofertas
- **CaptacionService**: Lógica de captación automática y ofertas estratégicas
- **ReportService**: Generación de reportes y análisis estadísticos del sistema
...
- **GridBagLayout y BorderLayout**: Para layouts responsivos y organizados
- **JTabbedPane**: Para organización en pestañas de la interfaz
...
1. **Identificación**: Detecta sectores con menos de 5 clientes (umbral configurable)
2. **Cálculo de Descuento**: Descuentos escalonados según criticidad:
   - Sectores muy críticos (0-33% del umbral): 30% descuento
   - Sectores críticos (34-66% del umbral): 20% descuento  
   - Sectores moderados (67-99% del umbral): 15% descuento
3. **Activación**: Aplica descuentos automáticamente por sector
4. **Monitoreo**: Genera reportes de efectividad y análisis detallado

### 🏛️ Patrones de Diseño Implementados
- **Repository Pattern**: Abstracción de acceso a datos con implementación en memoria
- **Service Layer**: Encapsulación de lógica de negocio con inyección de dependencias manual
- **Data Transfer Object (DTO)**: Clases internas para métricas y análisis en ReportService
...
- **Sectores críticos**: Número de sectores por debajo del umbral configurado (por defecto < 5 clientes)
...
- Desarrollo de validaciones robustas (RUT chileno, datos de entrada)
- Arquitectura de almacenamiento en memoria y gestión de datos
- Sistema de reportes y estadísticas avanzadas
- Configuración de Maven y estructura del proyecto

### **Maximiliano Rodriguez** 
- Diseño e implementación de la interfaz gráfica principal (MainWindow)
...
- Implementación del sistema de cuadrícula de sectores con indicadores visuales
